...
<head>
    <meta charset="utf-8">
    <title>Spiti Valley - Summer Special Group Trip </title>
                    ...
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-lg-12 center z-index1">
                                <h1 class="title">Spiti Bike Adventure </h1>
                                ...
                                <form action="/" class="sider-bar-tour-package">
                                    ...
                                    <div class="widget-filter-content">
                                        <div class="z-index3 relative">
                                            ...
                                            <h4 class="title text-white">Spiti Valley - Summer Special Group Trip </h4>
                                ...
                                <div class="col-lg-12">
                                    <form action="/" class="tf-my-listing mb-37">
                                        <div class="row align-center">
                                            <div class="col-sm-5">
                                                <p class="showing">Showing <span class="text-main">12</span> of 21
                                                    Adventures</p>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-package">
                                                    <div class="pack-image">
                                                        <a href="manali-to-srinagar-hanle-umling.php"
                                                ...
                                                <div class="col-md-8  col-package">
                                                    <div class="pac-content">
                                                        <div class="tour-listing-content" style="margin: 0px;">
                                                            <span class="map"><i class="icon-Vector4"></i>Delhi – Manali
                                                                – Jibhi – Sangla – Kalpa – Kaza – Chandrataal – Manali –
                                                                Delhi</span>
                                                            <h3 class="title-tour-list"><a
                                                                    href="manali-to-srinagar-hanle-umling.php">Spiti
                                                                    Valley - Summer Special Group Trip </a></h3>
                                                            <p class="para-title-tour">
                                                                Gear up for a thrilling summer escape into the wild
                                                                heart of the Himalayas! Ride through rugged mountain
                                                                trails, explore ancient monasteries perched atop cliffs,
                                                                and conquer high-altitude passes as you traverse the
                                                                untamed, breathtaking landscapes of Spiti Valley.
                                                            </p>
                                                            <div class="review">
                                                            ...
                                                            <div class="icon-box flex-three">
                                                                <div class="icons flex-three"><i
                                                                        class="icon-time-left"></i><span>5 Nights/6
                                                                        Days</span></div>
                                                            ...
                                                            <div class="flex-two">
                                                                ...
                                                                <div class="icon-bookmark"><i
                                                                        class="icon-Vector-151"></i></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-lg-12 col-iternary">
                                    ...
                                    <div class="itinerary">
                                        <div class="itinerary-header">
                                            <h2 class="h2-itinerary"> Spiti Valley - Summer Special Group Trip </h2>
                                            <p>6 Days / 5 Nights | Trans-Himalayan Adventure</p>
                                        </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location"> Delhi</span> <br>
                                            ...
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li><b>Evening:</b> Begin your adventure with an AC Volvo departure
                                                        from Delhi.</li>
                                                    <li><b>In Route:</b> Enjoy a delicious dinner on the way at your own
                                                        expense.</li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location"> Manali</span> <br>
                                                        Arrival in Manali
                                                    </p>
                                                </div>
                                                <i class="fa-solid fa-chevron-down"></i>
                                            ...
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li><b>Morning:</b> Arrive in Manali and check into your hotel.</li>
                                                    <li><b>Self Exploration:</b> Discover Vasishta Temple with its hot
                                                        springs, the ancient Hadimba Temple set amidst cedar forests,
                                                        stroll along the bustling Mall Road, and experience the serenity
                                                        of Jogini Waterfall.</li>
                                                    <li><b>Night:</b> Comfortable overnight stay in Manali with dinner.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location">Kaza</span>
                                                        <br>
                                                        Manali to Kaza
                                                    </p>
                                                </div>
                                            ...
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li><b>Morning:</b> Enjoy breakfast and check out of your hotel.
                                                    </li>
                                                    <li><b>Journey:</b> Travel through the remarkable Atal Tunnel,
                                                        leading
                                                        into the picturesque Lahaul Valley.</li>
                                                    <li><b>Evening</b>: Cross the breathtaking Kunzum La pass and reach
                                                        Kaza, the heart of Spiti Valley.</li>
                                                    <li></li><b>Night:</b> Dinner and restful overnight stay in Kaza.
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="day">
                                            ...
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li><b>Morning:</b> After breakfast, visit the ancient Dhankar
                                                        Monastery,
                                                        perched dramatically between rocky spurs and offering panoramic
                                                        views of the Spiti Valley.</li>
                                                    <li><b>Explore:</b> Dive into Pin Valley’s tranquility, explore
                                                        Kungri
                                                        Monastery, cross the Tailing hanging bridge, and experience the
                                                        quaintness of Mud village.</li>
                                                    <li><b>Night:</b> Return to Kaza for dinner and an overnight stay.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                <div class="icons">
                                                    ...
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location"> Kaza</span> <br>
                                                        Key Monastery, Hikkim, Komic, Langza
                                                    </p>
                                                </div>
                                                <i class="fa-solid fa-chevron-down"></i>
                                            </div>
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li><b>Morning:</b> Post-breakfast, visit Key Monastery, the largest
                                                        and oldest
                                                        monastery in Spiti, known for its stunning location and
                                                        spiritual
                                                        ambiance.</li>
                                                    <li><b>Explore:</b> Journey to Hikkim, home to the world’s highest
                                                        post office,
                                                        visit Komic, the highest village accessible by motorable road,
                                                        and
                                                        explore Langza, known for its ancient marine fossils and the
                                                        towering Buddha statue.</li>
                                                    <li><b>Night:</b> Return to Kaza, dinner, and overnight stay.</li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                <div class="icons">
                                                    ...
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location"> Chandra Taal</span>
                                                        <br>
                                            ...
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li><b>Morning:</b> Enjoy breakfast and check out.</li>
                                                    <li><b>Explore:</b> En route to Chandra Taal, visit the engineering marvel of
                                                    Chicham Bridge, pass through the serene Losar village, see the
                                                    wildlife-rich Kibber, and cross the high-altitude Kunzum Pass.</li>
                                                    <li><b>Evening: </b>Arrive at the stunning Chandra Taal, check into camps, and
                                                    admire the pristine beauty of the lake.</li>
                                                    <li><b>Night:</b> Dinner under the starlit sky and overnight stay in camps.</li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                <div class="icons">
                                                    ...
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location"> Pangong</span> <br>
                                                        Kaza → Chicham Bridge → Chandrataal
                                                    </p>
                                                </div>
                                                <i class="fa-solid fa-chevron-down"></i>
                                            </div>
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li>After breakfast, begin your ride towards the mystical
                                                        Chandrataal
                                                        Lake.</li>
                                                    <li>En route, cross the Chicham Bridge (Asia’s highest) and Kunzum
                                                        Pass,
                                                        the highest point of the trip.</li>
                                                    <li>Stop to visit Key Monastery and Kibber Village, then continue to
                                                        Batal and ride through one of the most dramatic landscapes of
                                                        the
                                                        journey.</li>
                                                    <li>From the parking area, take a short trek to witness the
                                                        mesmerizing
                                                        crescent-shaped Chandrataal Lake.</li>
                                                    <li>Dinner and overnight stay at the campsite near the lake.</li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                <div class="icons">
                                                    ...
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location"> Nubra</span> <br>
                                                        Chandrataal → Atal Tunnel → Manali
                                                    </p>
                                                </div>
                                                <i class="fa-solid fa-chevron-down"></i>
                                            </div>
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li>After an early breakfast, start your return journey to Manali
                                                        via
                                                        Batal – Chhatru – Atal Tunnel.</li>
                                                    <li>This stretch offers some of the most scenic and adventurous
                                                        terrain
                                                        of the entire trip.</li>
                                                    <li>Arrive in Manali by evening. Enjoy dinner and overnight stay at
                                                        the
                                                        hotel.</li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                <div class="icons">
                                                    ...
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location"> Leh</span> <br>
                                            ...
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li>After breakfast, spend a relaxed morning in Manali, exploring
                                                        cafes
                                                        or shopping at the local market.</li>
                                                    <li>By evening, board your Volvo for the overnight journey back to
                                                        Delhi, bringing this unforgettable Spiti Bike Adventure to a
                                                        close.</li>
                                                </ul>
                                            </div>
                                        </div>
