...
<head>
    <meta charset="utf-8">
    <title>Spiti Bike Adventure </title>
                                ...
                                <form action="/" class="sider-bar-tour-package">
                                    ...
                                    <div class="widget-filter-content">
                                        <div class="z-index3 relative">
                                            ...
                                            <h4 class="title text-white">Spiti Bike Adventure </h4>
                                                    ...
                                                    <div class="pac-content">
                                                        <div class="tour-listing-content" style="margin: 0px;">
                                                            ...
                                                            <p class="para-title-tour">
                                                                Conquer rugged Himalayan trails, ride through ancient
                                                                monasteries and high mountain passes, and push your
                                                                limits across the wild, untamed beauty of Spiti — an
                                                                adrenaline-fueled journey to the edge of the world.
                                                            </p>
                                                            <div class="review">
                                                            ...
                                                            <div class="icon-box flex-three">
                                                                <div class="icons flex-three"><i
                                                                        class="icon-time-left"></i><span>7 Nights/8
                                                                        Days</span></div>
                                ...
                                <div class="col-lg-12 col-iternary">
                                    ...
                                    <div class="itinerary">
                                        <div class="itinerary-header">
                                            <h2 class="h2-itinerary"> Spiti Bike Adventure </h2>
                                            <p>8 Days / 7 Nights | Trans-Himalayan Adventure</p>
                                        </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                <div class="icons">
                                                    ...
                                                    <p class="day-para"
                                                        ...
                                                        Delhi to Manali (Overnight Volvo Transfer)
                                                    </p>
                                                </div>
                                            ...
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li>Depart from Delhi at 8:30 PM by AC Volvo bus.</li>
                                                    <li>Overnight journey through the scenic Himalayan highways./li>
                                                    <li><b>Arrive in Manali</b> the next morning, surrounded by pine
                                                        forests and
                                                        mountain views.</li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                <div class="icons">
                                                    ...
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location"> Jibhi</span> <br>
                                                        Manali → Jibhi
                                                    </p>
                                                </div>
                                                <i class="fa-solid fa-chevron-down"></i>
                                            ...
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li>Arrive in Manali and freshen up. Riders will collect their bikes
                                                        and
                                                        go for a short test ride from Manali to Jibhi/Gushaini.</li>
                                                    <li>In route, enjoy winding mountain roads and river-side views.
                                                    </li>
                                                    <li>Check in to a cozy backpackers’ hostel in Jibhi.</li>
                                                    <li>Spend the evening exploring the valley, local cafés, and
                                                        waterfalls.</li>
                                                    <li>Dinner and overnight stay in Jibhi.</li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                <div class="icons">
                                                    ...
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location">Sangla Valley</span>
                                                        <br>
                                                        Jibhi to Sangla Valley via Rampur
                                                    </p>
                                                </div>
                                                <i class="fa-solid fa-chevron-down"></i>
                                            </div>
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li>After breakfast, gear up for an exciting 8-hour ride towards
                                                        Sangla
                                                        Valley.</li>
                                                    <li>The route offers breathtaking views throughout the journey.
                                                        In route, visit Chitkul, the last inhabited village on the
                                                        Indo-China border, often called “The Last Village of India.</li>
                                                    <li>Arrive in Sangla by evening, enjoy dinner, and rest overnight at
                                                        the
                                                        hotel.</li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                <div class="icons">
                                                    ...
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location">Kalpa</span>
                                                        <br>
                                                        Sangla to Kalpa
                                                    </p>
                                                </div>
                                            ...
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li>Post breakfast, start your 4–5 hour ride to Kalpa, a picturesque
                                                        village overlooking the majestic Kinner Kailash range.</li>
                                                    <li>Visit the famous Suicide Point and witness a stunning sunset
                                                        before
                                                        settling in for the night.</li>
                                                    <li>Dinner and overnight stay in Kalpa.</li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="day">
                                            ...
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li>Begin early with breakfast and embark on a thrilling 9-hour
                                                        journey
                                                        to Kaza via the spectacular Hindustan–Tibet Highway.</li>
                                                    <li>Witness the Khab Confluence, where the Spiti and Sutlej rivers
                                                        meet,
                                                        and enjoy views of Reo Purgyil Peak from Khab Bridge.</li>
                                                    <li>Stop at Nako for lunch (self-paid), cross the dramatic Malling
                                                        Nallah, and visit Gue Village to see the 500-year-old preserved
                                                        Mummy.</li>
                                                    <li>Arrive in Kaza by evening. Dinner and overnight stay at Kaza.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="day">
                                            <div class="day-header">
                                                <div class="icons">
                                                    ...
                                                    <p class="day-para"
                                                        style="color: black; font-weight: 500; padding-left: 20px;">
                                                        <span style="color: #ff7b00;"><img src="/assets/images/pin.png"
                                                                alt="location" class="pin-location"> Hanle</span> <br>
                                                        Kaza → Key Monastery → Komic → Langza → Hikkim
                                                    </p>
                                                </div>
                                                <i class="fa-solid fa-chevron-down"></i>
                                            </div>
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li></li>This is one of the most memorable days of the trip!
                                                    <li>
                                                        After breakfast, explore Spiti’s high-altitude marvels — <br>
                                                        <b>Hikkim:</b> Home to the world’s highest post office
                                                        <b>Komic:</b> The highest village connected by a motorable road
                                                        <b>Langza:</b> Famous for its giant Buddha statue and
                                                        spectacular mountain
                                                        backdrops
                                                    </li>
                                                    <li>Return to Kaza by evening for dinner and overnight stay.</li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="day">
                                            ...
                                            <div class="day-content">
                                                <ul class="day-details">
                                                    <li>After breakfast, spend a relaxed morning in Manali, exploring cafes
                                                    or shopping at the local market.</li>
                                                    <li>By evening, board your Volvo for the overnight journey back to
                                                    Delhi, bringing this unforgettable Spiti Bike Adventure to a close.</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
