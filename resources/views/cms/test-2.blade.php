...
<head>
  <meta charset="utf-8">
  <title>Manali-Srinagar with [Umlingla & Demchok]</title>
  ...
  <div id="wrapper">
    <div id="pagee" class="clearfix">
      ...
      <main id="main">
        ...
        <section class="breadcumb-section" style="background-image: url('./assets/images/page/aboutbnr.jpg');">
          <div class="tf-container">
            <div class="row">
              <div class="col-lg-12 center z-index1">
                <h1 class="title">Manali-Srinagar with [Umlingla & Demchok]</h1>
                ...
                <form action="/" class="sider-bar-tour-package">
                  ...
                  <div class="widget-filter-content">
                    <div class="z-index3 relative">
                      ...
                      <h4 class="title text-white">Manali-Srinagar with [Umlingla & Demchok]</h4>
                        ...
                        <div class="col-md-4 col-package">
                          <div class="pack-image">
                            <a href="manali-to-srinagar-hanle-umling.php" class="tour-listing-image">
                              ...
                              <img src="/assets/images/travel-list/mnli1.jpg"
                                alt="Manali to Srinagar via Hanle & Umling La"
                                style="width: 100%; height: 267px; object-fit: cover; margin-left: 12px; transition: transform 1s;">
                            </a>
                          </div>
                        </div>
                        ...
                        <div class="col-md-8  col-package">
                          <div class="pac-content">
                            <div class="tour-listing-content" style="margin: 0px;">
                              <span class="map"><i class="icon-Vector4"></i>Manali – Hanle – Umling La – Srinagar</span>
                              <h3 class="title-tour-list"><a href="manali-to-srinagar-hanle-umling.php">Manali-Srinagar with [Umlingla & Demchok]</a></h3>
                              <p class="para-title-tour">
                                Ride through dramatic Himalayan landscapes, explore remote border villages, and camp beneath star-studded skies for a once-in-a-lifetime adventure across the roof of the world.
                              </p>
                              <div class="review">
                              ...
                              <div class="icon-box flex-three">
                                <div class="icons flex-three"><i class="icon-time-left"></i><span>11 Nights/12 Days</span></div>
                                <div class="icons flex-three">
                                  <svg width="21" height="16" viewBox="0 0 21 16" fill="none"
                                    ...
                                    <path
                                      ...
                                      stroke="currentColor" stroke-width="1.7" stroke-linecap="round"
                                      stroke-linejoin="round" />
                                    <path d="M17.1035 15.1797V9.02734" stroke="currentColor" stroke-width="1.7"
                                      stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M20.1797 12.1035H14.0273" stroke="currentColor" stroke-width="1.7"
                                      stroke-linecap="round" stroke-linejoin="round" />
                                  </svg>
                                  <span>15 Riders</span>
                                </div>
                ...
                <div class="col-lg-12 col-iternary">
                  ...
                  <div class="itinerary">
                    ...
                    <div class="day">
                      <div class="day-header">
                        <div class="icons">
                          ...
                          <p class="day-para" style="color: black; font-weight: 500; padding-left: 20px;">
                            <span style="color: #ff7b00;"><img src="/assets/images/pin.png" alt="location"
                                class="pin-location"> Delhi</span> <br>
                      ...
                      <div class="day-content">
                        <ul class="day-details">
                          <li>Begin your journey with an overnight bus ride from Delhi to Manali.</li>
                          <li>Pickup location: Majnu ka Tila / ISBT Kashmiri Gate.</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="day">
                      <div class="day-header">
                        <div class="icons">
                          ...
                          <p class="day-para" style="color: black; font-weight: 500; padding-left: 20px;">
                            <span style="color: #ff7b00;"><img src="/assets/images/pin.png" alt="location"
                                class="pin-location"> Manali</span> <br>
                            Explore Manali
                          </p>
                        </div>
                        <i class="fa-solid fa-chevron-down"></i>
                      ...
                      <div class="day-content">
                        <ul class="day-details">
                          <li>Arrive in Manali and check in to your hotel.</li>
                          <li>Explore the charm of this scenic city, famous for its rich culture and stunning landscapes
                            (at your own). </li>
                          <li>In the late evening, join your fellow riders and trip captain for a safety briefing,
                            riding tips, and a preview of the upcoming adventures.</li>
                          <li>Bond with fellow adventurers over a delicious dinner.</li>
                          <li>End the day with an overnight stay at the hotel.</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="day">
                      <div class="day-header">
                        <div class="icons">
                          ...
                          <p class="day-para" style="color: black; font-weight: 500; padding-left: 20px;">
                            <span style="color: #ff7b00;"><img src="/assets/images/pin.png" alt="location"
                                class="pin-location">Sarchu</span> <br>
                      ...
                      <div class="day-content">
                        <ul class="day-details">
                          <li>In the morning, bikes will be allotted for your entire journey.</li>
                          <li>This day marks the adventurous start of your bike trip.</li>
                          <li>Ride through the scenic beauty of Keylong and Solang Valley, with its lush greenery.</li>
                          <li>Pass through the Atal Tunnel, one of the world’s longest highway tunnels at high altitude.
                          </li>
                          <li>Enjoy a quick meal at a local dhaba or roadside café.</li>
                          <li>Cross Baralacha La (16,040 ft) </li>
                          <li>Reach Sarchu for an overnight stay in camps.s</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="day">
                      <div class="day-header">
                        <div class="icons">
                          ...
                          <p class="day-para" style="color: black; font-weight: 500; padding-left: 20px;">
                            <span style="color: #ff7b00;"><img src="/assets/images/pin.png" alt="location"
                                class="pin-location">Tso Moriris</span> <br>
                    ...
                    <div class="day">
                      <div class="day-header">
                        <div class="icons">
                          ...
                          <p class="day-para" style="color: black; font-weight: 500; padding-left: 20px;">
                            <span style="color: #ff7b00;"><img src="/assets/images/pin.png" alt="location"
                                class="pin-location"> Hanles</span> <br>
                            Tso Moriri to Hanle
                          </p>
                        </div>
                        <i class="fa-solid fa-chevron-down"></i>
                      ...
                      <div class="day-content">
                        <ul>
                          <li>Start your ride from Tso Moriri, heading towards the remote village of Hanle.</li>
                          <li>Pass through the Mahe Bridge checkpoint and continue deeper into Ladakh.</li>
                          <li>Enjoy the scenic ride along the Indus River and through vast valleys.</li>
                          <li>Reach Hanle transit camp, the gateway to the world’s highest motorable pass, Umling La
                            Pass,
                            and check in for your overnight stay.</li>
                          <li>End the day with star gazing under the clear Ladakhi skies.</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="day">
                      <div class="day-header">
                        <div class="icons">
                          ...
                          <p class="day-para" style="color: black; font-weight: 500; padding-left: 20px;">
                            <span style="color: #ff7b00;"><img src="/assets/images/pin.png" alt="location"
                                class="pin-location"> Hanle</span> <br>
                      ...
                      <div class="day-content">
                        <ul>
                          <li>Begin the adventurous ride from Hanle towards Umling La Pass, the world’s highest
                            motorable
                            road.</li>
                          <li>Climb towards Umling La, navigating steep inclines and challenging roads.</li>
                          <li>Take a quick break at the famous Umling La restaurant.</li>
                          <li>Celebrate your achievement with pictures and rest briefly at the pass.</li>
                          <li>Start your descent back to Hanle, riding carefully through high-altitude terrain.</li>
                          <li>Reach Hanle by evening for dinner and a restful overnight stay.</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="day">
                      <div class="day-header">
                        <div class="icons">
                          ...
                          <p class="day-para" style="color: black; font-weight: 500; padding-left: 20px;">
                            <span style="color: #ff7b00;"><img src="/assets/images/pin.png" alt="location"
                                class="pin-location"> Pangong</span> <br>
                      ...
                      <div class="day-content">
                        <ul>
                          <li>Begin your ride from Hanle towards Pangong Lake.</li>
                          <li>Take the scenic and remote Chushul route, passing through barren landscapes and
                            picturesque
                            valleys, with water crossings along the way.
                          <li>Ride along the Indo-China border region and stop at the Rezang La War Memorial.</li>
                          <li>Reach Pangong Tso, soak in its beauty, and click amazing pictures to capture the memories.
                          </li>
                          <li>Check into your accommodation, enjoy your dinner.</li>
                          <li>Relax over a bonfire (at your own expense).</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="day">
                      <div class="day-header">
                        <div class="icons">
                          ...
                          <p class="day-para" style="color: black; font-weight: 500; padding-left: 20px;">
                            <span style="color: #ff7b00;"><img src="/assets/images/pin.png" alt="location"
                                class="pin-location"> Nubras</span> <br>
                      ...
                      <div class="day-content">
                        <ul>
                          <li>Start your ride from Pangong Lake towards Nubra Valley.</li>
                          <li>Ride through the villages of Durbuk and Tangtse.</li>
                          <li>Follow the scenic Shyok River route, enjoying views of rocky cliffs and river crossings.
                          </li>
                          <li>Visit Diskit Monastery, or enjoy a camel ride on the sand dunes of Hunder.</li>
                          <li>End the day with a hearty dinner and relax at your Nubra accommodation.</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="day">
                      <div class="day-header">
                        <div class="icons">
                          ...
                          <p class="day-para" style="color: black; font-weight: 500; padding-left: 20px;">
                            <span style="color: #ff7b00;"><img src="/assets/images/pin.png" alt="location"
                                class="pin-location"> Lehs</span> <br>
                      ...
                      <div class="day-content">
                        <ul>
                          <li>Start your ride from Nubra Valley towards Leh, beginning your ascent to Khardung La, one
                            of
                            the highest motorable passes in the world (18,379 ft).</li>
                          <li>Stop for a quick break at Khardung Village for lunch (depending on time).</li>
                          <li>Begin your descent towards Leh, navigating the winding roads.</li>
                          <li>Check into your hotel, freshen up, and then visit the Leh market.</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="day">
                      <div class="day-header">
                        <div class="icons">
                          ...
                          <p class="day-para" style="color: black; font-weight: 500; padding-left: 20px;">
                            <span style="color: #ff7b00;"><img src="/assets/images/pin.png" alt="location"
                                class="pin-location"> Kargil</span> <br>
                      ...
                      <div class="day-content">
                        <ul>
                          <li>Gear up for another adventurous day as you set off after breakfast towards Kargil.</li>
                          <li>Witness the confluence of the Zanskar and Indus Rivers along the way.</li>
                          <li>Visit the famous Magnetic Hill, Pathar Sahib Gurudwara, and the Hall of Fame Museum.</li>
                          <li>Ride past the Moon Landscape near Lamayuru Monastery, taking in the magnificent views.
                          </li>
                          <li>Ascend Namika La (12,198 ft), enjoying panoramic views of the surrounding mountains.</li>
                          <li>Conclude your day with dinner and an overnight stay at the hotel.</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="day">
                      <div class="day-header">
                        <div class="icons">
                          ...
                          <p class="day-para" style="color: black; font-weight: 500; padding-left: 20px;">
                            <span style="color: #ff7b00;"><img src="/assets/images/pin.png" alt="location"
                                class="pin-location"> Srinagar</span> <br>
                      ...
                      <div class="day-content">
                        <ul>
                          <li>After breakfast, begin your ride from Kargil towards Srinagar.</li>
                          <li>Visit the Kargil War Memorial and pay tribute to the brave Indian soldiers.</li>
                          <li>Ascend the Zoji La Pass (11,575 ft) and take a break in Dras.</li>
                          <li>Enjoy a lunch break in Sonamarg, surrounded by stunning landscapes.</li>
                          <li>Continue your journey to Srinagar, arriving by evening.</li>
                          <li>Check into your hotel, freshen up, and then visit the market and Dal Lake.</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="day">
                      ...
                      <div class="day-content">
                        <ul>
                          <li>​Proceed to the airport for your onward journey with our airport drop service.</li>
                          <li>Bid farewell to your fellow travelers and cherish the memories of your incredible Ladakh
                          adventure.</li>
                        </ul>
                      </div>
                    </div>
            ...
            <div class="callt-to-action flex-two" style="border-radius: 79px;">
              <div class="callt-to-action-content flex-three">
                ...
                <div class="content">
                  ...
                  <p class="des">Get ready to embark on thrilling adventures while exploring and enjoying the beauty of
                    nature.
