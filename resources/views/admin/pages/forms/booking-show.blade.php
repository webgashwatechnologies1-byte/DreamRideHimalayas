                ...
                <main id="main">
                    ...
                    <section class="profile-dashboard">
                        <div class="inner-header mb-40 flex-three" style="justify-content: space-between;">
                            <div>
                                <h3 class="title yellow-title">Booking Details</h3>
                                <p class="des">Full information about this booking</p>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="booking-box">
                                    <div id="bookingDetails"><p>Loading booking data...</p></div>
                                </div>
                            </div>
...
$(document).ready(function () {
    ...
    fetch(`/api/bookings/${bookingId}`)
        ...
        .catch(() => {
            $("#bookingDetails").html(`<p class="text-danger">Failed to load booking</p>`);
        });
    ...
    function renderBooking(b) {
        ...
        $("#bookingDetails").html(`
            <h4 class="mb-20 yellow-title">Booking ID: #${b.id}</h4>
...
$(document).ready(function () {
    ...
    function renderBooking(b) {
        ...
        $("#bookingDetails").html(`
            <h4 class="yellow-title mb-20">Booking ID: #${b.id}</h4>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-20">
                    ...
                    <p class="section-value">₹${b.amount}</p>
                </div>

                <div class="col-md-4 mb-20">
                    <p class="section-label">Payment</p>
                    <p class="section-value">${b.payment_status}</p>
                </div>
