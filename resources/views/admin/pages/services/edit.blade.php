...
<body class="body header-fixed">
      ...
      <div class="has-dashboard">
        ...
        <main id="main">
          <section class="profile-dashboard">
            <form id="editServiceForm" enctype="multipart/form-data" class="form-add-tour">
              @csrf
              <input type="hidden" id="serviceId" value="{{ $id }}">
              <div class="widget-dash-board pr-256 mb-75">
                <h4 class="title-add-tour mb-30">Edit Service Information</h4>
                ...
                <div class="grid-input-2 mb-45">
                  ...
                  <div class="input-wrap">
                    <label>Price (₹)</label>
                    <input type="number" name="price" id="price" placeholder="499" required>
                  </div>
                </div>

                <div class="input-wrap mb-45">
                  <label>Description</label>
                  <textarea name="description" id="description" rows="4" placeholder="Enter short service description..."></textarea>
                </div>
                ...
                <div class="input-wrap text-end mt-40">
                  <button type="submit" class="button-add">Update Service</button>
                </div>
              </div>
            </form>
          </section>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      // ===== Fetch Service Data =====
      $.get(`${APP_URL}/api/service/${serviceId}`, function (data) {
        $('#name').val(data.name);
        ...
        if (data.image) {
          ...
          $('#serviceImagePreview').html(`
            <div>
              <img src="${APP_URL}/${data.image}" alt="Service Image">
      ...
      $('#editServiceForm').on('submit', function (e) {
        ...
        $.ajax({
          url: `${APP_URL}/api/service/${serviceId}`,
          type: 'POST',
          data: formData,
          processData: false,
          contentType: false,
